...
export default function SOSHeroClaimAccess(){
 ...
 if(!show)return null;
 return <a href="/hero/claim" style={{position:'fixed',right:16,bottom:18,zIndex:1700,padding:'10px 13px',borderRadius:999,background:'rgba(13,27,43,.96)',color:'#ffd18a',border:'1px solid rgba(255,183,71,.28)',boxShadow:'0 12px 38px rgba(0,0,0,.3)',fontSize:9,fontWeight:900,letterSpacing:'.08em',textDecoration:'none',backdropFilter:'blur(14px)'}}>QUALIFIED CANDIDATE? CLAIM HERO PROFILE</a>;
}
