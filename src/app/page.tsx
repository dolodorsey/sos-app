    ...
    <main style={{ minHeight: '100vh', background: '#080808' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 40, flexWrap: 'wrap', justifyContent: 'center' }}>
          <KHGFormButton formType="inquiry" brandKey="sos" variant="accent" size="lg" label="Get In Touch" />
          <KHGFormButton formType="sponsor" brandKey="sos" variant="outline" size="lg" />
        </div>
      </section>
      ...
      <section style={{ padding: '80px 24px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div style={{
          ...
          <KHGFormButton formType="inquiry" brandKey="sos" variant="default" />
          <KHGFormButton formType="consultation" brandKey="sos" variant="default" />
          <KHGFormButton formType="hiring_inquiry" brandKey="sos" variant="default" />
          <KHGFormButton formType="volunteer" brandKey="sos" variant="default" />
          <KHGFormButton formType="rsvp" brandKey="sos" variant="default" />
          <KHGFormButton formType="nda" brandKey="sos" variant="default" />
        </div>
      </section>
    </main>
  );
